      ...
      >
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            >
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgws9EaQV6DEaQPy1KBjtNaQul5HkbFdqvHw&s"
                alt="About Us Image"
      ...
      >
        <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            >
              <img
                src="https://www.aravali.edu.in/website/images/2004_buiilding.webp"
