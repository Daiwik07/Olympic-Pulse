...
const MedalistPage = () => {
    // Calculate total number of medalist countries
    const totalCountries = medalistData.length;

    return (
        <div className="container mx-auto p-8 bg-gray-50 min-h-screen">
            <h1 className="text-3xl font-bold text-center mb-6 text-[#47B884]">Medalist Countries</h1>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {medalistData.map((data, index) => {
                            ...
                            return (
                                <tr key={index}>
                                    <td className="py-4 px-6 text-gray-900">{data.country}</td>
                                    <td className="py-4 px-6 text-center text-gray-900">{data.gold}</td>
                                    <td className="py-4 px-6 text-center text-gray-900">{data.silver}</td>
                                    <td className="py-4 px-6 text-center text-gray-900">{data.bronze}</td>
                                    <td className="py-4 px-6 text-center text-gray-900">{totalMedals}</td>
                                </tr>
                            );
                        })}
                    </tbody>
